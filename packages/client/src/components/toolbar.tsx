...
import { Backpack, Map, Settings, User, X } from "lucide-react";
            ...
            {activePanel && (
                ...
                >
                    <CardContent className="p-4 flex flex-col space-y-4 relative bg-gray-900 text-white">
                        ...
                        <h2 className={`${isMobile ? "text-base" : "text-lg"} font-bold capitalize`}>{activePanel}</h2>
